                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <form class="form" role="form" action="<%=request.getContextPath()%>/UpdateAccountController" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input class="form-control input-lg" type="text" name="name"  value="${account.username}" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control input-lg" type="text" name="email"  value="${account.fullname}" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control input-lg" type="text" name="phone"  value="${account.email}" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control input-lg" type="text" name="address"  value="${account.phonenumber}" required>
                                </div>
                                <div class="form-group">
