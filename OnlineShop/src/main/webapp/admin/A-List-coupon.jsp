                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="">Coupon</li>
                            <li class="active">List of coupons</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            <!-- row -->
                            <div class="row">
                                <h4>List Of Coupons (<b style="color: orange;">số lượng</b>)
                                </h4>
                                <p>
                                    <form role="search" class="app-search hidden-xs"
                                        style="margin-left: 35%;">
                                        <input type="text" placeholder="Search..." class="form-control" style="margin: auto; border: 0.5px solid ; border-color: rgba(228, 221, 221, 0.822);">
                                        <button type="button" class="btn btn-default waves-effect" style="background-color: rgb(255, 255, 255); border-radius: 70%;"><i
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="max-texts"> id</td>
                                                    <td class="max-texts"> desc</td>
                                                    <td class="max-texts"> percent</td>
