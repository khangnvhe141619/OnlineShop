        ...
        <div class="container-lg">
            <div class="table-responsive">
                <div class="table-wrapper">
                    <a href="blockAcc">Block</a>
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2>SellAccount<b>Details</b></h2></div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <c:forEach items="${listSA}" var="o" >
                                <tr>
                                    ...
                                    <td>${o.phone}</td>
                                    <td>
                                        <a href="managerAccount?aid=${o.id}">Block</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2>UserAccount<b>Details</b></h2></div>
                        </div>
                    </div>
                    <table class="table table-bordered">
                        <thead>
