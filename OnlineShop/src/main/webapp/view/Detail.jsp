...
<html>
    ...
    <body style="background: #0b0b0b">
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="background: url('images/car6.jpg')">
            <div class="container">
                <a class="navbar-brand" href="Page.jsp"><img src="images/car.png" style="width: 140px; height: 50px " alt=""/></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    ...
                    <form action="search" method="post" class="form-inline my-2 my-lg-0">
                        ...
                        <a class="btn btn-success btn-sm ml-3" href="show">
                            ...
                            <section class="jumbotron text-center" style="background: url('images/car7.jpg')">
            <div class="container" >
                <h1 class="jumbotron-heading" style="font-size: 50px;font-family: serif; color: white">VIATO</h1>
                <p class="lead text-muted mb-0">Uy tín tạo nên thương hiệu với hơn 10 năm cung cấp các siêu xe trên toàn thế giới</p>
            </div>
        </section>
        <div class="container">
            <div class="row">
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Sub-category</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        ...
                                        <a href="cart?cid=${detail.id}" class="btn btn-lg btn-outline-primary text-uppercase"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
                                    </article> <!-- card-body.// -->
                                </aside> <!-- col.// -->
                            </div> <!-- row.// -->
                        </div> <!-- card.// -->
