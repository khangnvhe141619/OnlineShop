                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <c:if test="${sessionScope.acc.isAdmin == 1}">
                                <a href="deleteProduct" class="btn btn-danger"><i class="material-icons">&#xE15C;</i> <span>Block</span></a>
                                <a href="AddCate.jsp" class="btn btn-danger"> <span>Add Category</span></a>
                            </c:if>
                    ...
                    <tbody>
                        <c:forEach items="${listPT}" var="o">
                            <tr>
                                ...
                                <td>${o.price} $</td>
                                <td>
                                    <a href="managerProduct?blID=${o.id}">Block</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
