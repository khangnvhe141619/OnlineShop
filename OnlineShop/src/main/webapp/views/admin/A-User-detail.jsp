                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="userName" class="form-control" style="border: none;"
                                                    id="" placeholder="User name" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-users"></i></div>
                                                <input type="text" name="fName" class="form-control" style="border: none;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-users"></i></div>
                                                <input type="text" name="lName" class="form-control" style="border: none;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="email" class="form-control" style="border: none;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="phone" class="form-control" style="border: none;"
                                                    id="" placeholder=" phone number" required="">
