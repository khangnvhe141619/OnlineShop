...
<title>Company Admin | Product Detail</title>
<!-- Bootstrap Core CSS -->
<link
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="white-box">
							<h3 class="box-title m-b-0">Edit Product Information</h3>
							<div class="row">
								<div class="col-sm-12 col-xs-12">
									<form action="<%=request.getContextPath()%>/AEditProduct" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="productName"
													value="${product.productName }" class="form-control" id=""
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="file" name="productImage"
													value="${product.image }" class="form-control" id=""
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="productDesc"
													value="${product.description }" class="form-control" id=""
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="issuingCompany"
													value="${product.issuingCompany }" class="form-control"
													id="" placeholder="">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="date" name="publicationDate" value="${product.publicationDate }" id=""
													placeholder=""">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" name="publishingCompany"
													value="${product.publishingCompany }" class="form-control"
													id="" placeholder="">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" name="numberOfPage"
													class="form-control" id="" value="${product.numberPage }" placeholder="">
											</div>
										</div>
