												...
												<tbody>
													<tr>
														...
														<c:if test="${list.status=='Cancel'}">
															<td class="max-texts" style="color: red;">
																${list.status}</td>
														</c:if>
														<c:if test="${list.status=='Pending'}">
															<td class="max-texts" style="color: orange;">
																${list.status}</td>
														</c:if>
														<c:if test="${list.status=='Completed'}">
															<td class="max-texts" style="color: green;">
																${list.status}</td>
														</c:if>
														<td class=""><a style="margin-left: 15%;"
															href="<%=request.getContextPath()%>/updateOrderAdminController?stt=${list.stt}&date=${list.orderDate}&shipper=${list.shipper}&status=${list.status}"><i
