...
<head>
    ...
    <title>Company Admin | List Departments</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            <!-- row -->
                            <div class="row">
                                <h4>List Of Departments (<b style="color: orange;">${count }</b>)
                                </h4>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="">
                                                         <a style="margin-left: 5%;" href="<%=request.getContextPath() %>/DeleteDepartmentController?id=${list.departmentId}" 
