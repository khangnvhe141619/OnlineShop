        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="<%=request.getContextPath()%>/listDepartmentController">Department</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Creating A New Department</h3>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                   <form class="form" role="form" action="<%=request.getContextPath()%>/addDepartment" method="post" onsubmit="return showCheck()">
                                        ...
                                        <div class="form-group">
                                            <label for="inputDepartmentDesc">Department Description</label>
                                            <div class="input-group">
