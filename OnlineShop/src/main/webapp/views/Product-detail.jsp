                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="<%=request.getContextPath()%>/resources/img/view-slider/large/polo-shirt-1.png" class="simpleLens-lens-image"><img src="<%=request.getContextPath()%>/resources/img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
                      </div>
                      <div class="simpleLens-thumbnails-container">
                          <a data-big-image="<%=request.getContextPath()%>/resources/img/view-slider/medium/polo-shirt-1.png" data-lens-image="img/view-slider/large/polo-shirt-1.png" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="<%=request.getContextPath()%>/resources/img/view-slider/thumbnail/polo-shirt-1.png">
                          </a>                                    
                          <a data-big-image="<%=request.getContextPath()%>/resources/img/view-slider/medium/polo-shirt-3.png" data-lens-image="img/view-slider/large/polo-shirt-3.png" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="<%=request.getContextPath()%>/resources/img/view-slider/thumbnail/polo-shirt-3.png">
                          </a>
                          <a data-big-image="<%=request.getContextPath()%>/resources/img/view-slider/medium/polo-shirt-4.png" data-lens-image="img/view-slider/large/polo-shirt-4.png" class="simpleLens-thumbnail-wrapper" href="#">
                     ...
                     <li>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" src="<%=request.getContextPath()%>/resources/img/testimonial-img-3.jpg" alt="girl image">
                            </a>
                          </div>
