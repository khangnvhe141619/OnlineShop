                ...
                <div class="container">
                    <div class="signin-content">
                        <div class="signin-image">
                            <figure><img src="<%=request.getContextPath()%>/resources/common/images/login-img.jpg" alt="sing up image"></figure>
                            <a href="signup.jsp" class="signup-image-link" style="text-decoration: none;">Create an account</a>
                        </div>
                        ...
                        <div class="signin-form">
                            ...
                            <form action="login" method="POST" class="register-form" id="login-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="your_name" placeholder="Your Name" value="${param.username}"/>
                                </div>
                                <div class="form-group">
                                    <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                    <input type="password" name="password" id="your_pass" placeholder="Password" value="${param.password}"/>
                                </div>
