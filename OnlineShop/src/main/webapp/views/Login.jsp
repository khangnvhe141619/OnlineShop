                ...
                <h4>Login</h4>
                 <form class="aa-login-form" method="POST" action="<%=request.getContextPath() %>/loginController" onsubmit="return Validate()">
                  ...
                  <label for="">Username or Email address<span>*</span></label>
                   <input id="email" type="text" placeholder="Username or email" name="email" value="${e1}">
                   <label for="">Password<span>*</span></label>
                    ...
                    <div class="aa-register-now">
              		Don't have an account?<a href="<%=request.getContextPath() %>/views/Register.jsp" style="color: red"> Register now!</a>
            		</div>
                  </form>
                </div>
              </div>
