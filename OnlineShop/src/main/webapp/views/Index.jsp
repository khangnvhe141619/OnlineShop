				...
				<div class="seq-screen">
					<ul class="seq-canvas">
						...
						<li>
							<div class="seq-model">
								<img data-seq
									src="<%=request.getContextPath()%>/resources/img/slider/1.jpg"
									alt="Men slide img" />
							</div>
							<div class="seq-title">
						...
						<li>
							<div class="seq-model">
								<img data-seq
									src="<%=request.getContextPath()%>/resources/img/slider/2.jpg"
						...
						<li>
							<div class="seq-model">
								<img data-seq
									src="<%=request.getContextPath()%>/resources/img/slider/3.jpg"
						...
						<li>
							<div class="seq-model">
								<img data-seq
									src="<%=request.getContextPath()%>/resources/img/slider/4.jpg"
									alt="Shoes slide img" />
							</div>
							<div class="seq-title">
								<span data-seq>Save Up to 75% Off</span>
						...
						<li>
							<div class="seq-model">
								<img data-seq
									src="<%=request.getContextPath()%>/resources/img/slider/5.jpg"
							...
							<div class="col-md-5 no-padding">
								<div class="aa-promo-left">
									<div class="aa-promo-banner">
										<img
											src="<%=request.getContextPath()%>/resources/img/promo-banner-1.jpg"
											alt="img">
							...
							<div class="col-md-7 no-padding">
								<div class="aa-promo-right">
									<div class="aa-single-promo-right">
										<div class="aa-promo-banner">
											<img
												src="<%=request.getContextPath()%>/resources/img/promo-banner-3.jpg"
												alt="img">
											<div class="aa-prom-content">
									...
									<div class="aa-single-promo-right">
										<div class="aa-promo-banner">
											<img
												src="<%=request.getContextPath()%>/resources/img/promo-banner-2.jpg"
												alt="img">
											<div class="aa-prom-content">
												<span>Sale Off</span>
												<h4>
									...
									<div class="aa-single-promo-right">
										<div class="aa-promo-banner">
											<img
												src="<%=request.getContextPath()%>/resources/img/promo-banner-4.jpg"
												alt="img">
											<div class="aa-prom-content">
									...
									<div class="aa-single-promo-right">
										<div class="aa-promo-banner">
											<img
												src="<%=request.getContextPath()%>/resources/img/promo-banner-5.jpg"
												alt="img">
											<div class="aa-prom-content">
												<span>25% Off</span>
												<h4>
									...
									<div class="tab-pane fade in active" id="men">
										<ul class="aa-product-catg">
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/man/polo-shirt-5.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/man/polo-shirt-6.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
									...
									<div class="tab-pane fade" id="sports">
										<ul class="aa-product-catg">
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-1.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-2.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-3.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-4.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-5.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-6.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-7.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/sports/sport-8.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
									...
									<div class="tab-pane fade" id="electronics">
										<ul class="aa-product-catg">
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-1.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-2.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-3.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-4.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-5.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-6.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-7.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img
														src="<%=request.getContextPath()%>/resources/img/electronics/electronic-8.png"
														alt="polo shirt img"></a>
													<a class="aa-add-card-btn" href="#"><span
														class="fa fa-shopping-cart"></span>Add To Cart</a>
													<figcaption>
				...
				<div class="col-md-12">
					<div class="row">
						<div class="aa-banner-area">
							<a href="#"><img
								src="<%=request.getContextPath()%>/resources/img/fashion-banner.jpg"
					...
					<div class="aa-testimonial-area">
						<ul class="aa-testimonial-slider">
							...
							<li>
								<div class="aa-testimonial-single">
									<img class="aa-testimonial-img"
										src="<%=request.getContextPath()%>/resources/img/testimonial-img-2.jpg"
							...
							<li>
								<div class="aa-testimonial-single">
									<img class="aa-testimonial-img"
										src="<%=request.getContextPath()%>/resources/img/testimonial-img-1.jpg"
										alt="testimonial img"> <span
										class="fa fa-quote-left aa-testimonial-quote"></span>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing
										elit. Sunt distinctio omnis possimus, facere, quidem
