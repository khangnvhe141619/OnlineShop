...
/**
 * Servlet implementation class AListPostController
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (request.getParameter("page") == null) {
				...
				request.getRequestDispatcher("views/admin/A-List-post.jsp").forward(request, response);
			} else {
