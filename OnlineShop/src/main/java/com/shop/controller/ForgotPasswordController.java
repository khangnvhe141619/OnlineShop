		...
		try {
			...
			if (account == null) {
				...
				String password="\r\n"
						...
						+ "                                            We just simply send you your old password.\r\n"
						+ "                                        </p>\r\n"
						+ "                                        <a href=\"javascript:void(0);\"\r\n"
						+ "                                            style=\"background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;\">"+account.getPassword()
						+ "                                            </a>\r\n"
						+ "                                    </td>\r\n"
						+ "                                </tr>\r\n"
						+ "                                <tr>\r\n"
